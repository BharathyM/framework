...
public class TC005_getEnumeratorActivities extends RESTAssuredBase {
	...
	public void getEnumeratorActivities() {
		...
		Response response = postWithHeaderParam(headers,"ofisenumeratorgpstracker/gps-tracking/getEnumeratorActivities");

...
public class TC002_getEnumeratorLatLngById extends RESTAssuredBase {
	...
	public void getEnumeratorLatLngById() {
		
		File file = new File(".//src/test/testdata/OFIS-Enumerator-GPS-Tracker/getEnumeratorLatLngById.json");

...
public class TC005_loadFarmerLookUP extends RESTAssuredBase {
	...
	public void loadFarmerLookUP() {
		...
		Response response = postWithHeaderParam(headers,"ofiscoffeedataupload/surveyjob/uploadFarmer?moduleId=25&isRegister=true&useFarmerId=true");

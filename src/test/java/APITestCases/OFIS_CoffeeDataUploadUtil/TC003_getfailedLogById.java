...
public class TC003_getfailedLogById extends RESTAssuredBase {
	...
	public void getfailedLogById() {
		...
		Response response = getWithHeader(headers,"ofiscoffeedataupload/surveyfarmer/log/failed?id=25");

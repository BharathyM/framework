...
public class TC006_removeBlobUrl extends RESTAssuredBase {
	...
	public void removeBlobUrl() {
		...
		Response response = postWithHeaderParam(headers,"ofiscoffeedataupload/surveyjob/fdp/removeBlobURL/");

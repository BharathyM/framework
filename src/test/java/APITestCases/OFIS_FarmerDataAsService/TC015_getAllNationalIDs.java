...
public class TC015_getAllNationalIDs extends RESTAssuredBase {
	...
	public void getAllNationalIDs () {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/nationalId/getAllNationalIDs");

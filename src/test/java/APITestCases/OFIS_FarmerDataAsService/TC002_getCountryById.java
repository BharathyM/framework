...
public class TC002_getCountryById extends RESTAssuredBase {
	...
	public void getCountryById() {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/getCountryById?countryId=13");

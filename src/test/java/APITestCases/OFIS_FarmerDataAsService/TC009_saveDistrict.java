...
public class TC009_saveDistrict extends RESTAssuredBase {
	...
	public void saveDistrict() {
		...
		File file = new File(".//src/test/testdata/OFIS-Farmer-Data-As-Service/saveDistrict.json");
		...
		Response response = postWithBodyAndHeaderParam(headers,file,"ofisfarmer-data-as-service/master/save/saveDistrict");

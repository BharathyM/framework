...
public class TC029_getAllUniqueIDs extends RESTAssuredBase {
	...
	public void getAllUniqueIDs() {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/nationalId/getAllUniqueIDs");

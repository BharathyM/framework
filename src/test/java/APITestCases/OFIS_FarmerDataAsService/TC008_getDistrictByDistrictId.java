...
public class TC008_getDistrictByDistrictId extends RESTAssuredBase {
	...
	public void getDistrictByDistrictId() {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/getDistrictById?districtId=2350");

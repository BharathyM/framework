...
public class TC027_saveDistrict extends RESTAssuredBase {
	...
	public void saveDistrict() {
		...
		Response response = postWithBodyAndHeaderParam(headers,file,"ofisfarmer-data-as-service/master/save/subDistrict");

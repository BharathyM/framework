...
public class TC026_getSubDistrictById extends RESTAssuredBase {
	...
	public void getSubDistrictById() {
		...
		Response response = postWithBodyAndHeaderParam(headers,file,"ofisfarmer-data-as-service/master/getSubDistrictById?subDistrictId=2179");

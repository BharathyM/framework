...
public class TC017_getPlaceByPlaceId extends RESTAssuredBase {
	...
	public void getPlaceByPlaceId () {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/getPlaceByPlaceId?placeId=2");

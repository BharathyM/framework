...
public class TC006_deactivateCountry extends RESTAssuredBase {
	...
	public void deactivateCountry() {
		...
		File file = new File(".//src/test/testdata/OFIS-Farmer-Data-As-Service/deactivateCountry.json");
		...
		Response response = postWithBodyAndHeaderParam(headers,file,"ofisfarmer-data-as-service/master/country?code=13");

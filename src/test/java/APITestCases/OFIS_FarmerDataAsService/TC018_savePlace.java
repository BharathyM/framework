...
public class TC018_savePlace extends RESTAssuredBase {
	...
	public void savePlace () {
		...
		File file = new File(".//src/test/testdata/OFIS-Farmer-Data-As-Service/savePlace.json");
		...
		Response response = postWithBodyAndHeaderParam(headers,file,"ofisfarmer-data-as-service/master/addPlace");

...
public class TC030_getUniqueIds extends RESTAssuredBase {
	...
	public void getUniqueIds() {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/nationalId/getUniqueID?id=3");

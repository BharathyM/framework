...
public class TC022_getRegionForRegionId extends RESTAssuredBase {
	...
	public void getRegionForRegionId () {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/getRegionByRegionId?regionId=350");

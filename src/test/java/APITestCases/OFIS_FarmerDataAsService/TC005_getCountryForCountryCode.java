...
public class TC005_getCountryForCountryCode extends RESTAssuredBase {
	...
	public void getCountryForCountryCode() {
		...
		Response response = getWithHeader(headers,"ofisfarmer-data-as-service/master/country?code=13");

...
public class TC001_yearForDashboard extends RESTAssuredBase {
	...
	public void yearForDashboard() {
		...
		Response response = getWithHeader(headers,"ofisli-calculator/api/yearForDashboard");

...
public class TC003_getAllSubmittedmodules extends RESTAssuredBase {
	...
	public void getAllSubmittedmodules() {
		...
		Response response = getWithHeader(headers, "ofischildsurvey/ofischildsurvey/childsurvey/134");

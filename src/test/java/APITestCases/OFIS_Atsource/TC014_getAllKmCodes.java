...
public class  TC014_getAllKmCodes extends RESTAssuredBase{
		 ...
		 @BeforeTest
		    ...
		    @Test
			        ...
			        Response response = getWithHeader(headers, "ofisatsource/atsource/reviews/getAllKmCodes");

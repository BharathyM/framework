...
public class TC013_getDownloadList extends RESTAssuredBase {
	...
	@Test
	public void findchildrenbystatus() {

		Map<String, String> headers = new HashMap<String, String>();
		RestAssured.useRelaxedHTTPSValidation();
		headers.put("Authorization", TOKEN);
		Response response = getWithHeader(headers, "ofischild/child/findchildrenbystatus?statusId=1");

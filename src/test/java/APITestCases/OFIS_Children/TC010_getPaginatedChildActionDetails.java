...
public class TC010_getPaginatedChildActionDetails extends RESTAssuredBase {
	...
	public void getChildHistory() {
		...
		Response response = getWithHeader(headers, "ofischild/child/history/details?childId=134&pageNo=1&size=50");

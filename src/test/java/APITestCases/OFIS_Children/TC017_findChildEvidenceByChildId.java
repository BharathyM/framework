...
public class TC017_findChildEvidenceByChildId extends RESTAssuredBase {
	...
	@Test
	public void findChildEvidenceByChildId() {

		Map<String, String> headers = new HashMap<String, String>();
		RestAssured.useRelaxedHTTPSValidation();
		headers.put("Authorization", TOKEN);
		Response response = getWithHeader(headers, "ofischild/child/evidence?childId=134&surveyYear=2019");

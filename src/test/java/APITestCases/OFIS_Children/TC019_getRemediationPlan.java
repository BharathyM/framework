...
public class TC019_getRemediationPlan extends RESTAssuredBase {
	...
	@Test
	public void getRemediationPlan() {

		Map<String, String> headers = new HashMap<String, String>();
		RestAssured.useRelaxedHTTPSValidation();
		headers.put("Authorization", TOKEN);
		Response response = getWithHeader(headers, "ofischild/child/getremediationplan");

...
public class TC022_getRemediationPlanForCountry extends RESTAssuredBase {
	...
	@Test
	public void getRemediationPlanForCountry() {

		Map<String, String> headers = new HashMap<String, String>();
		RestAssured.useRelaxedHTTPSValidation();
		headers.put("Authorization", TOKEN);
		Response response = getWithHeader(headers, "ofischild/child/getremediationplans?countryId=1");

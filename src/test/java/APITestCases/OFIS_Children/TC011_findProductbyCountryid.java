...
public class TC011_findProductbyCountryid extends RESTAssuredBase {
	...
	@Test
	public void findProductbyCountryid() {

		Map<String, String> headers = new HashMap<String, String>();
		RestAssured.useRelaxedHTTPSValidation();
		headers.put("Authorization", TOKEN);
		Response response = getWithHeader(headers, "ofischild/child/findProductbyCountryid?countryId=13");

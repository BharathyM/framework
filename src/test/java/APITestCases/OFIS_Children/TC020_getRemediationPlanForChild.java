...
public class TC020_getRemediationPlanForChild extends RESTAssuredBase {
	...
	@Test
	public void getRemediationPlanForChild() {

		Map<String, String> headers = new HashMap<String, String>();
		RestAssured.useRelaxedHTTPSValidation();
		headers.put("Authorization", TOKEN);
		Response response = getWithHeader(headers, "ofischild/child/getremediationplan/134/2019");

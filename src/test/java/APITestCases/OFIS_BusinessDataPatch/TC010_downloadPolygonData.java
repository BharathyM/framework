...
public class TC010_downloadPolygonData extends RESTAssuredBase{
	 ...
	 @BeforeTest
	    ...
	    @Test
			    public void downloadPolygonData() {
	    	
			        Map<String, String> headers = new HashMap<String, String>();
			        RestAssured.useRelaxedHTTPSValidation();
			        headers.put("Authorization", TOKEN);
			        Response response = getWithHeader(headers, "ofisbusinessdatapatch/polygonData/download/123");

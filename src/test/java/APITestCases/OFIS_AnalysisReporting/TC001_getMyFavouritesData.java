...
public class TC001_getMyFavouritesData extends RESTAssuredBase{
	 ...
	 @BeforeTest
	    ...
	    @Test
			    ...
			    public void getMyFavouritesData() {
			        ...
			        Response response = getWithHeader(headers, "ofisanalysisreporting/api/v1/reporting/getMyFavourites?userId=23");

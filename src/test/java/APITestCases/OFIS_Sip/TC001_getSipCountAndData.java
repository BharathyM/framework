...
public class TC001_getSipCountAndData extends RESTAssuredBase {
	...
	public void getSipCountAndData() {
		...
		Response response = getWithHeader(headers,"ofissip/sip/getSipCountAndData");

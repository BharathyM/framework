...
public class TC003_refeshCache extends RESTAssuredBase {
	...
	public void refeshCache() {
		...
		Response response = postWithHeaderParam(headers,"ofisfgfilters/fgfilters/refreshUserFiltersCache/323");

...
public class TC003_getQuestionDetails extends RESTAssuredBase {
	...
	public void getQuestionDetails () {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/calculatedType/getQuestionDetails?moduleId=2&calculatedTypeId=43");

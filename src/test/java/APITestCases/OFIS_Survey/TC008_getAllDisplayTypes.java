...
public class TC008_getAllDisplayTypes extends RESTAssuredBase {
	...
	public void getAllDisplayTypes() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/questions/getAllDisplayType");

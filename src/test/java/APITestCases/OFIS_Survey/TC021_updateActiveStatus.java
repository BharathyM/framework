...
public class TC021_updateActiveStatus extends RESTAssuredBase {
	...
	public void updateActiveStatus() {
		...
		Response response = putWithHeader(headers,"ofissurvey/survey/modules/updatesurveystatus/23?activeFlag=true");

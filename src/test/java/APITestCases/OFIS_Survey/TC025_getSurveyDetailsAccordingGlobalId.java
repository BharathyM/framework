...
public class TC025_getSurveyDetailsAccordingGlobalId extends RESTAssuredBase {
	...
	public void getSurveyDetailsAccordingGlobalId() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/saveLocalUnitActive?id=12&active=true");

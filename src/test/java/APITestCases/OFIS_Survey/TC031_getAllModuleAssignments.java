...
public class TC031_getAllModuleAssignments extends RESTAssuredBase {
	...
	public void getAllModuleAssignments() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/moduleassignments/getModuleAssignments");

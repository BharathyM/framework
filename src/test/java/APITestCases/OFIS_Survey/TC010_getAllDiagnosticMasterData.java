...
public class TC010_getAllDiagnosticMasterData extends RESTAssuredBase {
	...
	public void getAllDiagnosticMasterData() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/getAllDiagnosticMasterData");

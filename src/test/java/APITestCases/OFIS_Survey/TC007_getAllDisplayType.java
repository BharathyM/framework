...
public class TC007_getAllDisplayType extends RESTAssuredBase {
	...
	public void getAllDisplayType() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/getAllDisplayType");

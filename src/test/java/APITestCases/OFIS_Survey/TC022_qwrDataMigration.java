...
public class TC022_qwrDataMigration extends RESTAssuredBase {
	...
	public void qwrDataMigration() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/qwr/dataMigration/234");

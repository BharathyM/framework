...
public class TC019_getAllDiagnosticModuleData extends RESTAssuredBase {
	...
	public void getAllDiagnosticModuleData() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/diagnostic/getAllDiagnosticModuleData");

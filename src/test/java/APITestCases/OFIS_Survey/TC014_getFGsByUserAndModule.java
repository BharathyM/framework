...
public class TC014_getFGsByUserAndModule extends RESTAssuredBase {
	...
	public void getFGsByUserAndModule() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/getFGsByUserAndModule?userId=123&moduleId=456");

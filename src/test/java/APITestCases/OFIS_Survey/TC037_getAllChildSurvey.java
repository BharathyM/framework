...
public class TC037_getAllChildSurvey extends RESTAssuredBase {
	...
	public void getAllChildSurvey() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/get/childsurvey");

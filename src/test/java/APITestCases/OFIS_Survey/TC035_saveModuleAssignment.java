...
public class TC035_saveModuleAssignment extends RESTAssuredBase {
	...
	public void saveModuleAssignment() {
		...
		headers.put("userscopes", "edit_questions");
		Response response = getWithHeader(headers,"ofissurvey/survey/moduleassignments/11/edit");

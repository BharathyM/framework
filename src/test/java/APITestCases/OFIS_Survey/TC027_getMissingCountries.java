...
public class TC027_getMissingCountries extends RESTAssuredBase {
	...
	public void getSurveyDetailsAccordingGlobalId() {
		...
		Response response = postWithBodyAndHeaderParam(headers,file,"ofissurvey/survey/getMissingCountries");

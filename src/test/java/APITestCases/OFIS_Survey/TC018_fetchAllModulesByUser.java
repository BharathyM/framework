...
public class TC018_fetchAllModulesByUser extends RESTAssuredBase {
	...
	public void fetchAllModulesByUser() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/fetchAllModulesByUser?userId=12");

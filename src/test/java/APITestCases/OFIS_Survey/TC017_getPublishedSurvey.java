...
public class TC017_getPublishedSurvey extends RESTAssuredBase {
	...
	public void getPublishedSurvey() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/publishedsurvey/view?moduleId=12");

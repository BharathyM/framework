...
public class TC036_getAllAssignmentType extends RESTAssuredBase {
	...
	public void getAllAssignmentType() {
		...
		Response response = getWithHeader(headers,"ofissurvey/survey/moduleassignments/getAllAssignmentType");
